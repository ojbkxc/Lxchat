 ...
 * its platform with an "æ—§ç‰ˆ" tag and a one-tap migrate action.
 */
@Composable
...
internal fun ImPlatform.emoji(): String = when (this) {
    ImPlatform.WECHAT -> "ğŸ’¬"
    ImPlatform.TELEGRAM -> "âœˆï¸"
    ImPlatform.LARK -> "ğŸ¦"
    ImPlatform.DINGTALK -> "ğŸ“Œ"
    ImPlatform.WECOM -> "ğŸ¢"
    ImPlatform.QQ -> "ğŸ§"
    ImPlatform.DISCORD -> "ğŸ®"
    ImPlatform.SLACK -> "ğŸ’¼"
    ImPlatform.WHATSAPP -> "ğŸŸ¢"
    ImPlatform.SMS -> "ğŸ“±"
}
...
// â”€â”€ Credential field schema per platform â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Credential encode / decode (stored in ImGatewayConfig.token as JSON) â”€â”€â”€â”€
...
// â”€â”€ Bot summary row â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        if (method == BindMethod.QR) {
            ...
            Surface(
                ...
                Column(
                    ...
                    Text(text = "ğŸ“·", style = MaterialTheme.typography.displaySmall)
                    Spacer(modifier = Modifier.height(6.dp))
                    Text(
        ...
        Box(modifier = Modifier.fillMaxWidth().padding(vertical = 4.dp)) {
            OutlinedTextField(
                ...
                onValueChange = { /* åªè¯»ï¼Œç”±ä¸‹æ–¹ Dropdown é€‰æ‹© */ },
                readOnly = true,
            ...
            flow.bind { event ->
                when (event) {
                    ...
                    is WeixinBindingFlow.Event.Success -> {
                        DebugLog.d("WeixinQrBind", "æ‰«ç ç»‘å®šæˆåŠŸ: baseUrl=${event.baseUrl}")
                        loading = false
                        onConfirm(ImGatewayConfig(
                            ...
                            botId = event.botId, // G1: å†™å…¥ ilink_bot_id
                        ))
                    }
                    is WeixinBindingFlow.Event.Failure -> {
                        DebugLog.e("WeixinQrBind", "æ‰«ç ç»‘å®šå¤±è´¥: ${event.error.code} - ${event.error.message}")
