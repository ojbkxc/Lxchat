    ...
    fun fetchBuiltinRuntimeCatalog(): MarketIndex = MarketIndex(
        plugins = listOf(
            MarketPluginMeta(
                ...
                downloadUrl = "https://github.com/ojbkxc/lxchat-runtime/releases/download/node-v24.0.0/node-24.0.0-android-arm64.zip",
                runtimeType = "node",
                versions = listOf("24.0.0"),
                minVersion = "24.0.0",
            ),
            MarketPluginMeta(
                id = "runtime-python",
                ...
                downloadUrl = "https://github.com/ojbkxc/lxchat-runtime/releases/download/python-v{version}/python-{version}-android-arm64.zip",
                runtimeType = "python",
            ...
            MarketPluginMeta(
                ...
                downloadUrl = "https://github.com/ojbkxc/lxchat-runtime/releases/download/ffmpeg-v9.0.1/ffmpeg-9.0.1-android-arm64.zip",
                runtimeType = "ffmpeg",
                versions = listOf("9.0.1"),
                minVersion = "9.0.1",
            ),
        ),
    )
