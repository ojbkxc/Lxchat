...
interface Plugin {
    ...
    /** Skills exposed by this plugin. Default returns an empty list.
     *  A plugin is a multi-capability container: tools + skills + settings schema.
     *  The [PluginHost] aggregates every plugin's skills into its [SkillHost]. */
    fun skills(): List<Skill> = emptyList()
