...
This guide walks you through installing LxChat, adding your first API key, and sending your first message.

## Installation

### From F-Droid (Recommended)

LxChat is available on F-Droid, the open-source Android app store.

1. Install [F-Droid](https://f-droid.org/) on your device
2. Open F-Droid, search for **LxChat**
3. Tap **Install**

### From GitHub Releases

1. Visit the [Releases page](https://github.com/ojbkxc/lxchat/releases)
...
1. Clone the repository:
   ```
   git clone https://github.com/ojbkxc/lxchat.git
   ```
...
When you open LxChat for the first time, you'll see a welcome screen with a text input. Before you can chat, you need to configure a provider and an API key.
...
3. LxChat fetches the latest model list for all configured providers
...
LxChat has a clean layout centered around the chat screen:
