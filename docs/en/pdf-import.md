...
LxChat can extract and send selected pages from PDF files as images to vision-capable models.
...
4. Confirm — LxChat extracts the pages as images and sends them to the model
...
After selecting pages, tap the confirm button. LxChat:
