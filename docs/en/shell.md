...
LxChat can execute commands on remote machines through the [Conch](https://github.com/ojbkxc/conch) protocol — an end-to-end encrypted secure shell designed for AI agents.

## How It Works

```text
LxChat (Android)  ──ECDH + AES-256-GCM──▶  Conch Server (Linux/macOS/Windows)
                                           │
                                           ├── Execute commands
...
Deploy the Conch server on your target machine. See the [Conch repository](https://github.com/ojbkxc/conch) for setup instructions.

### Step 2: Add Device in LxChat
...
See the [Conch documentation](https://github.com/ojbkxc/conch) for MCP setup instructions.
