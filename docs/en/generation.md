...
When enabled, LxChat visually indicates which messages are included in the current context window vs. which have been rolled out (excluded due to the context window limit). This helps you understand:
