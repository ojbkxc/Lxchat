...
Welcome to the LxChat user manual. LxChat is a BYOK (Bring Your Own Key) LLM client for Android with multi-provider access, non-linear branching conversations, agentic tool calling, and remote device control.
...
- **[Data Portability](import-export.md)** — export/import .lxchat files, auto backup, import from Claude and ChatGPT
...
LxChat is a BYOK Android client for AI power users:
...
- **Open source**: AGPL-3.0 licensed, [source on GitHub](https://github.com/ojbkxc/lxchat)
