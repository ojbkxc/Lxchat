...
欢迎查阅 LxChat 用户手册。LxChat 是一款 BYOK（自带密钥）Android LLM 客户端，支持多提供商接入、非线形分支对话、代理工具调用、图像生成、代码执行和远程设备控制。
...
- **[数据迁移](import-export.md)** — 导出/导入 .lxchat 文件、自动备份，从 Claude 和 ChatGPT 导入
...
LxChat 是一款面向 AI 高级用户的 BYOK Android 客户端：
...
- **开源**：AGPL-3.0 协议，[源码在 GitHub](https://github.com/ojbkxc/lxchat)
