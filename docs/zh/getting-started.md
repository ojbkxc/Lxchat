...
本指南将带你完成安装 LxChat、添加第一个 API 密钥并发送第一条消息。

## 安装

### 通过 F-Droid（推荐）

LxChat 已上架 F-Droid 开源应用商店。

1. 在设备上安装 [F-Droid](https://f-droid.org/)
2. 打开 F-Droid，搜索 **LxChat**
3. 点按 **安装**

### 通过 GitHub Releases

1. 访问 [Releases 页面](https://github.com/ojbkxc/lxchat/releases)
2. 下载最新的 `.apk` 文件
3. 在设备上打开文件，按提示确认安装
...
首次打开 LxChat 时，你会看到一个带有文本输入框的欢迎界面。在开始聊天之前，需要先配置提供商和 API 密钥。
